...
public class VF extends javax.swing.JFrame {
    ...
    String user,pass;
    public VF(String user, String pass) {
        initComponents();
        setUndecorated(true);
        this.user=user;
        this.pass=pass;
    ...
    private void initComponents() {
        ...
        del_txt_field2 = new javax.swing.JTextField();
        ...
        del_txt_field3 = new javax.swing.JTextField();
        ...
        DeleteBtn2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Background/if_f-cross_256_282471.png"))); // NOI18N
        ...
        jPanel5.add(DeleteBtn2);
        DeleteBtn2.setBounds(935, 308, 100, 30);

        del_txt_field2.setForeground(new java.awt.Color(153, 153, 153));
        del_txt_field2.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        del_txt_field2.setText("Del Via ID");
        del_txt_field2.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                del_txt_field2MouseClicked(evt);
            }
        });
        del_txt_field2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                del_txt_field2ActionPerformed(evt);
            }
        });
        jPanel5.add(del_txt_field2);
        del_txt_field2.setBounds(1045, 309, 100, 30);
        ...
        Clear_Btn2.setBounds(935, 357, 210, 30);
        ...
        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, vendorMain1List1, jTable4);
        ...
        columnBinding.setColumnName("Purchase Date");
        ...
        DeleteBtn3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Background/if_f-cross_256_282471.png"))); // NOI18N
        ...
        jPanel6.add(DeleteBtn3);
        DeleteBtn3.setBounds(943, 336, 104, 30);

        del_txt_field3.setForeground(new java.awt.Color(153, 153, 153));
        del_txt_field3.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        del_txt_field3.setText("Del Via ID");
        del_txt_field3.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                del_txt_field3MouseClicked(evt);
            }
        });
        del_txt_field3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                del_txt_field3ActionPerformed(evt);
            }
        });
        jPanel6.add(del_txt_field3);
        del_txt_field3.setBounds(1053, 337, 100, 30);
        ...
        Clear_Btn3.setBounds(943, 367, 210, 30);
        jPanel6.add(date);
        ...
        Glassmaterialcombo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tempered", "Mirror", "Annealed", "Ceramic" }));
        ...
        jLabel29.setBounds(-20, 0, 1200, 570);
    ...
    private void DeleteBtn2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteBtn2ActionPerformed
        ...
        v.setMyUser(user);
        v.setMyPass(pass);
        v.deleteVendorOnly(Integer.parseInt(del_txt_field2.getText()));
        v.FetchVendorOnly(jTable3);
    }//GEN-LAST:event_DeleteBtn2ActionPerformed

    private void del_txt_field2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_del_txt_field2MouseClicked
        // TODO add your handling code here:
        del_txt_field2.setText("");
    }//GEN-LAST:event_del_txt_field2MouseClicked

    private void del_txt_field2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_del_txt_field2ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_del_txt_field2ActionPerformed
...
//            V.ShowGlassQuantity(tg, ag, mg, cg, tgp, agp, mgp, cgp);
    ...
    private void DeleteBtn3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteBtn3ActionPerformed
        ...
        v.setMyUser(user);
        v.setMyPass(pass);
        v.delete(Integer.parseInt(del_txt_field3.getText()));
        v.FetchVendor(jTable4);
    }//GEN-LAST:event_DeleteBtn3ActionPerformed

    private void del_txt_field3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_del_txt_field3MouseClicked
        // TODO add your handling code here:
        del_txt_field3.setText("");
    }//GEN-LAST:event_del_txt_field3MouseClicked

    private void del_txt_field3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_del_txt_field3ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_del_txt_field3ActionPerformed
...
//        vv.ShowGlassQuantity(tg, ag, mg, cg, tgp, agp, mgp, cgp);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField del_txt_field2;
    private javax.swing.JTextField del_txt_field3;
